...
**Monday (Day 12).** First day of class! Had some introductions to the School of Code curriculum, and basic tenets of agile team flow and computational thinking. I also met my pair programmer for the week, and we spent a good bit of the day playing some CSS games to get used to pair programming and to get to know each other. It was a fun and a very new experience compared to how I've usually coded before (hunched over a CSS stylesheet in my room, furiously scowling while I'm trying to get a website to stop looking quite so ugly) so that was fun to try out. Another thing that felt very new but also really energising was the fact that the bootcamp really is a community, both of current students, alumni, mentors, and lots of other folks. It was great to meet some of the larger team, and to get to know other people in the same boat.

Outside of the things we went over at SoC today – CSS selectors, algorithms and computational thinking – I decided to pause on the freeCodeCamp JavaScript module for a bit, just until we hit that part of the course, so I don't get my wires crossed. Really great first day, though, and less nervous than I was yesterday!
...
Git and GitHub were a bit challenging at first, but the more you practice, the easier they become. My main downfall is accidentally cloning repos down into the last directory I was previously working in. Hoping that becomes muscle memory and I stop doing it so much soon! (Madison from ten days in the future, here – no, Madison of the past, you will not.)

**Wednesday (Day 14).** Looking back at my daily tweet for today's entry about my _#100DaysOfCode_ progress, and all it says is 'JavaScript more like JavaRIP', so you can probably imagine how my first real introduction to properly using JS went!

Luckily, my actual diary was a bit more detailed as I'm typing this up. We got started learning JavaScript, and tried building a few functions and a password checker. We got the first half of it to work - if a correct password is entered - but not if an incorrect password is entered. The loop kept cutting out halfway through.

I spent a good bit of the evening trying to figure it out, but I'm trying to be mindful of something Chris (Meah, SoC CEO and founder and also tutor) said on our first day. We're trying to build habits that will sustain us through a whole career. It is not worth burning out while learning code, and honestly, presenteeist exhaustion is only a net detrimental in all aspects. So! I stopped working on it, and crocheted for a bit of a rest.

I also sent an email reaching out to my in-industry mentor to set up our first meeting today, so will be able to report back on that soon!

**Thursday (Day 15).** Carried on playing with the password checker and made a bit of progress, and set up the meeting officially with my mentor for Friday after class. A bit nervous! Eek!

Me and my programming partner also did some more challenges today working with arrays and objects, and managed to get through all our set tasks for our workshops before time ran out, which admittedly might be a small win, but it was one we were both proud of nevertheless! We also both felt a lot more comfortable with git and GitHub, using the command line and the terminal, and VSC. Little things, maybe, but having that progress in a relatively short timeframe feels good and solid.

We got the CSS koala to look right with set px values – we've been working on him on-off through the week – but when we tried to make him reactive today in our out-of-class time, he tragically lost his various eyeballs and ears and noses and such to all four corners of the viewport. Learning doesn't come without trials, though, so fixing him up will be a weekend job!

**Friday (Day 16).** First hackathon ever! Our goal was to build a rock-paper-scissors game in JavaScript, which was a bit fast-and-loose, but it worked in the end, which is what matters most! Excited to carry on perfecting it at the weekend. Had a lot of fun with my programming partner and I think we learned a lot, both technically about JS, as well as more broadly about how to work as a team building a project to a deadline. At the end of the day, we presented our progress back to a small group of other teams, and being able to look at other people’s code and to see how creative an endeavour coding is was really interesting and useful.

I also had my introductory meeting with my in-industry mentor, which was a lot less scary than I thought it might be! It was really interesting to hear about his journey and experiences, and I'm looking forward to chatting again next week.
...
Firstly, this week really emphasised to me that things don't have to be perfect on the first try, or even the second or third. Getting something to work, even if it's not too sophisticated at first, is the very first goal to pursue: you can always refactor afterwards. Not a new lesson, but an important one to remember.
...
**Monday (Day 19).** Bank Holiday, so no SoC today! Carried on going over workshops from earlier, though, worked on some for loops and arrays for a bit because I'm the least confident with those, and I did a few levels on Codewars. Took it easier, though, today: did a lot of work on Saturday and Sunday, so did some gardening! Turnips are looking grand! Radishes are looking dire! Such is life!
...
**Thursday (Day 22).** My instinct was right, hilariously and tragically – another long one! We had a workshop where we had to try and do a virtual space-themed escape room, using fetch requests with APIs to call for and send back information about some rocket ship launch codes.

What held us up wasn't a technical challenge at all, in the end, but we were trying to over-solve a problem that did not need solving. We tried for a good while to display the information from our API in various onscreen formats, none of which was necessary in the end – we literally just needed to fetch the data (which we actually did in a comically short amount of time at the beginning of the workshop, ultimately) and read it in the console. On the plus side, learning not to over-solve problems is a lesson best learned earlier rather than later, at least! (And it was a little funny when one of the coaches pointed our needless extra work out.)

Tomorrow is the hackathon, and I'm a bit nervous for it this week, but you just have to take every day as it comes. I finished some bits of code that had seemed really troublesome at the beginning of the week today, in my spare time, so if nothing else, I know things are sinking in and getting easier.

I also started an extra project that I’m going to try and work on in my spare time. It’s another version of last week's rock-paper-scissors except it’s run entirely through APIs rather than the prompts and call loops we were building with previously. Funny to think back on how much you can learn even in the shortest timeframe.
...
After we knew we wanted to use these specific elements, we moved onto Plan 1.1: thinking about MVPs and agile working, we decided to start off by building a basic webpage that took one input from one button to begin with, and generated a profile of a pokemon from the PokeAPI. After we got all of that together and working, fulfilling our base goals, we then moved on to implementing more features and slightly more complex code, writing up new mini-plans and stretch goals as we went, and keeping a note at the bottom of our code of refactoring ideas and helpful things we learned in the process of building.

Our ultimate project ended up being a kind of 'guess that pokemon' game, where the computer would generate a random pokemon profile by pulling from the PokeAPI; we disguised some of the data we'd stored in onscreen variables from the user's view, so they would have to try and guess what pokemon profile they had been generated based on limited information. If they guessed right, the full profile and a congratulation message would be revealed, and if not, they would receive the failure message instead. My teammate wanted to work on their CSS knowledge, so they added some cool styling features to the first iteration of the final product, and I learned a lot in fixing one of our JavaScript issues while they were hard at work. We did a very short presentation back to a smaller group of thirty people about our progress and work at the end of the day, and it was really nice to be able to articulate what we'd accomplished, what we'd hope to accomplish with more time, where some of our challenges had been, and then to compare that to the other teams and their experiences.

We didn't reach all our stretch goals in the end, but we made a lot of progress from where we first started, especially considering how challenging some of the concepts we learned this week had seemed before Friday. I'm really proud of what we built, and I think a real strength of our team – and a working habit I'm going to take away from this week – is the process of methodical but adaptable planning and progress review. I think it was a practice that really helped us, and will prove useful in the long-run.

I also had another chat with my mentor after class, and got some really good advice on a few questions I'd been mulling over in the week, and some interesting resource pointers. It was a pretty long day, but I wanted to get through some work and was feeling pretty energised after the hackathon, so I also got through the whole weekend’s recap tasks in the evening. Just have a few bits and bobs to go over for the rest of the weekend.
...
**Sunday (Day 25).** Woke up early and spent the first part of the morning converting last week's rock-paper-scissors game from being console-based only to being interactive with the DOM and displaying on the webpage. Haven't done any styling yet, but I've got some ideas noted down that I'm going to try out later or next week in my free time.
